    ...
    public class EmailService
    {
        ...
        public async Task SendConfirmationCodeAsync(string toEmail, string code)
        {
            ...
            var mailMessage = new MailMessage
            {
                ...
                Subject = "E-poçt Təsdiq Kodu",
                Body = $@"
            <h2>E-poçt Təsdiqləmə</h2>
            <p>Qeydiyyatı tamamlamaq üçün aşağıdakı kodu daxil edin:</p>
            <h1 style='color: #2196F3; letter-spacing: 5px;'>{code}</h1>
            <p>Bu kod <strong>15 dəqiqə</strong> ərzində keçərlidir.</p>
